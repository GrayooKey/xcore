/**
 * 功能: 该文件是多级联动的核心配置文件, 跟其它的几个文件【chooseAdress.css（样式文件）、Popt.js(固定配置)、dataJson.js(数据文件)】构成一个完整的js组件
 * 用处: 一般用于编辑页面的多级联动
 * 用法: SelCity3()方法用于三级联动, SelCity4()方法用于四级联动, SelCity5()方法用于五级联动
 *
 * 版本: 1.0
 * 日期: 2019/8/1
 * 编辑者: xuezb
...
function SelCity3(obj, e) {
    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").remove();			//先清空上一次的内容,
        $("#_citys1").append(citySS);		//再添加此次内容
        $("._citys1").hide();				//将三个div全部隐藏,
        $("._citys1:eq(1)").show();			//再显示第二个div(市级div)

        $("#_citys0 a,#_citys1 a,#_citys2 a").removeClass("AreaS");	//先清空之前div的样式AreaS,
        $(this).addClass("AreaS");												//再为最新的div添加样式AreaS

        ths.value = $(this).data("name");			//点击省级后输入框的值(省),
        $("#" + province_).val($(this).data("id"));	//省级编码code(隐藏框),

        $("#" + city_).val(null);					//再将省级下(市、区)code清空
        $("#" + district_).val(null);
        ...
        $("#_citys1 a").click(function () {
            ...
            $("#_citys1 a,#_citys2 a").removeClass("AreaS");			//先清空之前div的样式AreaS,
            $(this).addClass("AreaS");											//再为最新的div添加样式AreaS
            ...
            $("#_citys2 a").click(function () {
                $("#_citys2 a").removeClass("AreaS");				//先清空之前div的样式AreaS,
                $(this).addClass("AreaS");										//再为最新的div添加样式AreaS
...
function SelCity5(obj, e) {
    ...
    $("#_citys0 a").click(function () {
        ...
        $("#_citys1 a").remove();			//先清空上一次的内容,
        $("#_citys1").append(citySS);		//再添加此次内容
        $("._citys1").hide();				//将五个div全部隐藏,
        $("._citys1:eq(1)").show();			//再显示第二个div(市级div)

        /*	三级——>四级——>五级   改动点二: $("#_citys0 a,#_citys1 a,#_citys2 a......").removeClass("AreaS");	*/
        $("#_citys0 a,#_citys1 a,#_citys2 a,#_citys3 a,#_citys4 a").removeClass("AreaS");	//先清空之前div的样式AreaS,
        $(this).addClass("AreaS");												//再为最新的div添加样式AreaS

        ths.value = $(this).data("name");			//点击省级后输入框的值(省),
        $("#" + province_).val($(this).data("id"));	//省级编码code(隐藏框),

        /*	三级——>四级——>五级   改动点三: $("#"+xxxxx).val(null);	*/
        $("#" + city_).val(null);					//再将省级下(市、区、街道、村)code清空
        $("#" + district_).val(null);
        $("#" + street_).val(null);
        $("#" + village_).val(null);
        ...
        $("#_citys1 a").click(function () {
            ...
            /*	三级——>四级——>五级   改动点四: $("#_citys1 a,#_citys2 a,#_citys3 a......").removeClass("AreaS");	*/
            $("#_citys1 a,#_citys2 a,#_citys3 a,#_citys4 a").removeClass("AreaS");			//先清空之前div的样式AreaS,
            $(this).addClass("AreaS");											//再为最新的div添加样式AreaS
            ...
            $("#_citys2 a").click(function () {
                ...
                /*	三级——>四级——>五级   改动点五: $("#_citys2 a,#_citys3 a......").removeClass("AreaS");	*/
                $("#_citys2 a,#_citys3 a,#_citys4 a").removeClass("AreaS");				//先清空之前div的样式AreaS,
                $(this).addClass("AreaS");										//再为最新的div添加样式AreaS
                ...
                //街道/镇的点击
                $("#_citys3 a").click(function () {
                    var villageSS = getVillage($(this));	//获取选中街道的所有社区/村
                    $("#_citys4 a").remove();			//先清空上一次的内容,
                    $("#_citys4").append(villageSS);		//再添加此次内容
                    $("._citys1").hide();				//将四个div全部隐藏,
                    $("._citys1:eq(4)").show();			//再显示第五个div(社区/村div)

                    $("#_citys3 a,#_citys4 a").removeClass("AreaS");				//先清空之前div的样式AreaS,
                    $(this).addClass("AreaS");										//再为最新的div添加样式AreaS
                    ...
                    $("#_citys4 a").click(function () {
                        $("#_citys4 a").removeClass("AreaS");						//先清空之前div的样式AreaS,
                        $(this).addClass("AreaS");									//再为最新的div添加样式AreaS
                        ...
                        var hD = $("#hDistrict").val();
                        var hS = $("#hStreet").val();
                        ths.value = hP + "-" + hC + "-" + hD + "-" + hS + "-" + $(this).data("name");		//点击区县后输入框的值(省+市+区县+街道/镇+社区/村)
                        $("#" + village_).val($(this).data("id"));								//村级编码code(隐藏框)

                        var lev = $(this).data("name");
                        if (document.getElementById("hVillage") == null) {
                            var hiddenIputs = $('<input>', {
                                type: 'hidden', name: "hVillage", "data-id": $(this).data("id"), id: "hVillage", val: lev
                            });
                            $(ths).after(hiddenIputs);
                        } else {
                            $("#hVillage").val(lev);
                            $("#hVillage").attr("data-id", $(this).data("id"));
                        }
